...
const EmojiConf = [
    ['🎉 [庆祝]', ':tada:', '初次提交;初始化'],
    ['🚧 [施工]', ':construction:', '工作进行中;开发'],
    ['💄 [口红]', ':lipstick:', '更新 UI 和样式文件'],
    ['✅ [复选框]', ':white_check_mark:', '增加测试'],
    ['👌 [OK]', ':ok_hand:', '由于代码评审更改而更新代码;功能迭代'],
    ['🐛 [bug]', ':bug:', '修复 bug'],
    ['✏️ [铅笔]', ':pencil2:', '修理;修补;优化'],
    ['📝 [备忘录]', ':memo:', '撰写文档'],
    ['💡 [灯泡]', ':bulb:', '在源代码中添加或更新注释'],
    ['🚀 [火箭]', ':rocket:', '部署功能'],
    ['🎨 [调色板]', ':art:', '改进代码结构/代码格式;格式化'],
    ['🔥 [火焰]', ':fire:', '移除代码或文件'],
    ['✨ [火花]', ':sparkles:', '引入新功能'],
    ['⚰️ [棺材]', ':coffin:', '删除死代码'],
    ['🔇 [静音]', ':mute:', '删除日志'],
    ['🔧 [扳手]', ':wrench:', '修改配置文件'],
    ['🥅 [目标网络]', ':goal_net:', '捕捉错误;异常;error'],
    ['🔨 [锤子]', ':hammer:', '重大重构'],
    ['🛂 [护照检查]', ':passport_control:', '处理与授权、角色和权限相关的代码'],
    ['🍻 [啤酒]', ':beers:', '醉醺醺地写代码'],
    ['⏪️ [倒带]', ':rewind:', '还原更改;回滚'],
    ['📱 [iphone手机]', ':iphone:', '致力于响应性设计'],
    ['💬 [对话]', ':speech_balloon:', '添加或更新文本和文字;文案'],
    ['🚑 [急救车]', ':ambulance:', '重要补丁'],
...
/**获取emoji表格 */
exports.EmojiTable = function () {
    const head = [
        'emoji',
        'emoji代码',
        'commit说明'
    ]
    const table = util.GetTable(EmojiConf, head)
    console.log(table)
}

/**获取emoji列表 */
exports.EmojiList = function () {
    print.Messages(EmojiConf)
}